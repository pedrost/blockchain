...
module.exports = {
  blocks: Chain.blocks,
  getLatestBlock: Chain.getLatestBlock,
  isValidChain: Chain.isValidChain,
  replaceChain: Chain.replaceChain,
  generateNextBlock: Chain.generateNextBlock,
  isValidNewBlock: Chain.isValidNewBlock,
  addBlock: Chain.addBlock
};
